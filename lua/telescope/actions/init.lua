...
--- first argument or they can be a custom type. To transform a module of
--- functions into a module of actions, you need to do the following:
---
--- <code>
...
--- can be found in the `developers.md` and `lua/tests/automated/action_spec.lua` file
---@brief ]]
